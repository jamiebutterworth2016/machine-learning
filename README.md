...
| --------------------- | ----------- | ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Unsupervised learning | Y           |              | Feed existing inputs into the model.<br/>The model groups data points into categories.<br/>New inputs are also categorised.<br/>[About unsupervised learning.](unsupervised-learning.md)                                                                                  |
